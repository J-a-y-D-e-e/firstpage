...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#111127] text-white relative">
      {/* Particle Canvas */}
      <canvas id="particleCanvas" className="fixed inset-0 z-0" />

      <div className="relative z-10 min-h-screen overflow-auto">
        {/* Header */}
        <header className="flex items-center justify-between p-6 bg-[#132043]">
